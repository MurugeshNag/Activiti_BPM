...
//stencil items
  ...
  final String STENCIL_TASK_WEBSERVICE = "WebServiceTask";
  ...
  final String PROPERTY_WEBSERVICETASK_ENDPOINT_URL= "webservicetaskendpointurl";
  final String PROPERTY_WEBSERVICETASK_LANGUAGE= "webservicetasklanguage";
  final String PROPERTY_WEBSERVICETASK_PAYLOAD_EXPRESSION= "webservicetaskpayloadexpression";
  final String PROPERTY_WEBSERVICETASK_RESULT_VARIABLE= "webservicetaskresultvariable";

...
public class ServiceTaskJsonConverter extends BaseBpmnJsonConverter {
    ...
    protected void convertElementToJson(ObjectNode propertiesNode, BaseElement baseElement) {
        ...
        } else if ("webservice".equalsIgnoreCase(serviceTask.getType())) {
            setPropertyFieldValue(PROPERTY_WEBSERVICETASK_ENDPOINT_URL, "endpointUrl", serviceTask, propertiesNode);
            setPropertyFieldValue(PROPERTY_WEBSERVICETASK_LANGUAGE, "language", serviceTask, propertiesNode);
            setPropertyFieldValue(PROPERTY_WEBSERVICETASK_PAYLOAD_EXPRESSION, "payloadExpression", serviceTask, propertiesNode);
            setPropertyFieldValue(PROPERTY_WEBSERVICETASK_RESULT_VARIABLE, "resultVariable", serviceTask, propertiesNode);

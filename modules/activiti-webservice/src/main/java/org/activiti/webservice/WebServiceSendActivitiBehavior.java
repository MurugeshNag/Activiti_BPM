...
import org.webservice.DefaultWebServiceMessage;
import org.webservice.api.WebServiceContext;
import org.webservice.api.WebServiceMessage;
import org.webservice.api.client.LocalWebServiceClient;
import org.webservice.util.IOUtils;

/**
 * @author MurugeshNag
 */
public class WebServiceSendActivitiBehavior extends AbstractBpmnActivityBehavior {
  ...
  protected WebServiceContext getWebServiceContext() {
    if (this.webServiceContext == null) {
      ...
      this.webServiceContextContext = (WebServiceContext) beans.get("webserviceContext");
    }

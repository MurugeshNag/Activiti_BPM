...
public interface ActivityBehaviorFactory {
  ...
  public abstract ActivityBehavior createWebServceActivityBehavior(ServiceTask serviceTask, BpmnModel bpmnModel);

  public abstract ActivityBehavior createWebServceActivityBehavior(SendTask sendTask, BpmnModel bpmnModel);

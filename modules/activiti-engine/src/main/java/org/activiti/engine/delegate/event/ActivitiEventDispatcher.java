...
/**
 * Dispatcher which allows for adding and removing {@link ActivitiEventListener}s to the activiti Engine as well
 * as dispatching {@link ActivitiEvent} to all the listeners registered.
 * 
